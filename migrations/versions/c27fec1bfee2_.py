...
def upgrade():
    ...
    op.create_index('notices_published_desc_idx', 'notice', [sa.text('published DESC')], unique=False)
    op.create_index('notices_published_idx', 'notice', ['published'], unique=False)
